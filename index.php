            ...
            <div class="col-lg-6">
                <form action="index" method="post" class="form-horizontal login-form">
                    <input type="hidden" name="token" value="<?php echo $_SESSION['token'] ?? '' ?>">
								<fieldset>
									<legend>Join Promoter Program</legend>
...
<!--bankin info-->
	<div class="control-group">
												...
												<div class="controls">
												<input id="textinput" name="bank_name" type="text" placeholder="" class="input-xlarge" value="<?php echo $_POST['bank_name'];?>" required>
												</div>
											</div>
	...
	<div class="control-group">
												...
												<div class="controls">
												<input id="textinput" name="account_name" type="text" placeholder="" class="input-xlarge" value="<?php echo $_POST['account_name'];?>" required>
												</div>
											</div>
											
												<div class="control-group">
												<label class="control-label" for="account_number">Account Nmuber</label>
												<div class="controls">
												<input id="textinput" name="account_number" type="text" placeholder="" class="input-xlarge" value="<?php echo $_POST['account_number'];?>" required>
												</div>
											</div>
                ...
                <form method="post" action="access/process_login" class="form-horizontal login-form">
							...
							<!--<div class="affiliate-description">
								<h1><i class="fa fa-help-circled"></i> Why Join our Promoter Program?</h1>
								<ul>
									<li><i class="fa fa-ok-circled2"></i> Earn 20% on every sale you send us!<li>
