...
if($media=='link'){
	...
	$stmt = $mysqli->prepare("INSERT INTO ap_banners (filename, filetype, adsize, url, description) VALUES (?, ?, ?, ?, ?)");
	$stmt->bind_param('sssss', $customlink, $filetype, $adsize, $customlink, $linkdes);
	$stmt->execute();
	$stmt->close();
